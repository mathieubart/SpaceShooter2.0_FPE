...
public class StartOptions : MonoBehaviour
{
    ...
    public int sceneToStart2 = 2;										//Index number in build settings of scene to load if changeScenes is true
    ...
    public void CustomizeButtonClicked()
    {
        ...
        //If changeScenes is true, start fading and change scenes halfway through animation when screen is blocked by FadeImage
        if (menuSettingsData.nextSceneIndex2 != 0)
        {
            //Use invoke to delay calling of LoadDelayed by half the length of fadeColorAnimationClip
            Invoke("LoadDelayed", menuSettingsData.menuFadeTime);
        ...
        SceneManager.LoadSceneAsync("JimSandbox");
        Destroy(gameObject);
    }
    ...
    public void TwoPlayers()
    {
        ...
        {
            //numberOfPlayers = 2;
            //Done_GameController.Instance.numberOfPlayer = 2;
        }

        else
        {
           // Done_GameController.Instance.numberOfPlayer = 1;
            //numberOfPlayers = 1;
        }
    }
}
